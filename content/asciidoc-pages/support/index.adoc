...
[width="100%",cols="6*",options="header",]
|===

| Java Version  | Upstream lead maintainer | First Availability | Latest Release | Next Release Due | End of Availability ^[1]^
