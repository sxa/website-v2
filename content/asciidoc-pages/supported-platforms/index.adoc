...
| RHEL 9.x | icon:times[] footnote:nojit[JDK8 on s390 has no JIT so is unsupported.] | icon:check[] | icon:check[] | icon:times[]
| RHEL 8.x | icon:times[] footnote:nojit[] | icon:check[] | icon:check[] | icon:times[]
